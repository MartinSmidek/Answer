...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr" slick-uniqueid="1" spellcheck="false">
 ...
 <body style="padding:100px">
  <div style="background-color:#cce; width:700px">
   <div style="float:right;padding:5px;">7.12.2015</div>
   <div style="padding:50px;">
    Vážení klienti, milí kamarádi,
    <br><br>na serveru je od začátku prosince 2015 nainstalována nová verze systému Answer.
    ...
    teprve až si vše vyzkoušíte, začněte pracovat v ostré verzi (2) - zapamatujte si po jejím spuštění
    novou adresu v záložce prohlížeče (vyhnete se příště tomuto upozornění).
    <br><br>Pokud byste potřebovali nějakou informaci nebo vysvětlení, zavolejte mi prosím na 603 150 565,
    ...
    <br><br>
    <button onclick="createCookie('ezer_db2_go',1,1);window.location.href='http://answer.setkani.org/db2.php';">(2) Chci pracovat s novou verzí</button>
   </div>
  </div>
 </body>
</html>
